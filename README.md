...
* いいね機能
    * 投稿されているコメントにいいねボタンを表示、押すとカウントが増え、コメントに表示される
    * マイページにいいねした、された総数を表示
...
* 画像投稿機能
    * 目的<br>画像投稿ができる
    * 詳細<br>・画像投稿機能の実装<br>・投稿時のスタンスに応じて、表示位置を変える<br>・プレビューを表示する<br>・画像の保存はS3にて行う
    * ユースケース<br>・チャットルームのコメント投稿フォームの画像選択ボタンを押し、画像を選択する<br>・選択された画像はプレビュー表示される<br>・コメントを投稿するボタンを押すと画像が投稿され、選択したスタンス側に表示される

* いいね機能
    * 目的<br>いいね機能を実装
    * 詳細<br>投稿されたコメントにいいねボタンを表示<br>・いいねボタンを押すとカウントが1上がる、再度押すと1下がる
    * ユースケース<br>コメントのいいねボタンを押すとボタンの色が変わり、隣の値が1増える<br>・いいねしたボタンを再度押す事でいいねが解除され、値が1減る
